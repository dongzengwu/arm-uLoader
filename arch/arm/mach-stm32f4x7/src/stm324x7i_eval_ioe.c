/**
  ******************************************************************************
  * @file    STM324x7i_eval_ioe.c
  * @author  MCD Application Team
  * @version V1.0.0
  * @date    11-January-2013
  * @brief   This file provides a set of functions needed to manage the STMPE811
  *          IO Expander devices mounted on STM324x7I-EVAL evaluation board.
  ******************************************************************************
  * @attention
  *
  ...
  */
  ...
  /* File Info : ---------------------------------------------------------------
    ...
    UNSUPPORTED FEATURES:
      - Row ADC Feature is not supported (not implemented on STM324x7I_EVAL board)
  ----------------------------------------------------------------------------*/
...
/** @defgroup STM324x7I_EVAL_IOE_Private_TypesDefinitions
  * @{
  */
/**
  * @}
...
/** @defgroup STM324x7I_EVAL_IOE_Private_Defines
  * @{
  */
...
/** @defgroup STM324x7I_EVAL_IOE_Private_Macros
  * @{
  */
/**
  * @}
...
/** @defgroup STM324x7I_EVAL_IOE_Private_Variables
  * @{
  */
...
/** @defgroup STM324x7I_EVAL_IOE_Private_FunctionPrototypes
  * @{
  */
...
/** @defgroup STM324x7I_EVAL_IOE_Private_Functions
  * @{
  */
...
/**
  ...
  *         (IOs, Touch Screen ..) and configures all STM324x7I_EVAL necessary
